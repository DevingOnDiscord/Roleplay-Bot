...
module.exports = {
    ...
    async execute(client:djs.Client, message:djs.Message, args, config){
        // const member : djs.Member = message.member
        // const guild : djs.Guild = message.guild.id
        const helpEmbed : djs.MessageEmbed = new djs.MessageEmbed()
